...
const STATE: Screen = Screen::Splash;

pub(super) fn plugin(app: &mut App) {
    // Spawn splash screen.
    app.insert_resource(ClearColor(SPLASH_BACKGROUND_COLOR));
    app.add_systems(OnEnter(STATE), spawn_splash);
    ...
    app.add_systems(OnEnter(STATE), insert_splash_timer);
    app.add_systems(OnExit(STATE), remove_splash_timer);
    app.add_systems(
        Update,
        (
